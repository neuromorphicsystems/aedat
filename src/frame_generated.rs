...
impl<'a> Frame<'a> {
  ...
  pub fn exposure_begin_t(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(Frame::VT_EXPOSURE_BEGIN_T, Some(0)).unwrap()}
  }
  #[inline]
  pub fn exposure_end_t(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(Frame::VT_EXPOSURE_END_T, Some(0)).unwrap()}
  }
  #[inline]
  pub fn format(&self) -> FrameFormat {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<FrameFormat>(Frame::VT_FORMAT, Some(FrameFormat::Gray)).unwrap()}
  }
  #[inline]
