...
impl<'a> ImuPacket<'a> {
  ...
  pub fn elements(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Imu<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Imu>>>>(ImuPacket::VT_ELEMENTS, None)}
  }
}
...
pub fn root_as_imu_packet(buf: &[u8]) -> Result<ImuPacket<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_imu_packet(buf: &[u8]) -> Result<ImuPacket<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_imu_packet_unchecked(buf: &[u8]) -> ImuPacket<'_> {
  unsafe { ::flatbuffers::root_unchecked::<ImuPacket>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_imu_packet_unchecked(buf: &[u8]) -> ImuPacket<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<ImuPacket>(buf) }
}
...
#[inline]
pub fn finish_size_prefixed_imu_packet_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>, root: ::flatbuffers::WIPOffset<ImuPacket<'a>>) {
