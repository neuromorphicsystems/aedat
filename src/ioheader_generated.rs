...
impl<'a> Ioheader<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        args: &'args IoheaderArgs<'args>) -> flatbuffers::WIPOffset<Ioheader<'bldr>> {
  ...
  pub fn compression(&self) -> Compression {
    self._tab.get::<Compression>(Ioheader::VT_COMPRESSION, Some(Compression::None)).unwrap()
  }
  #[inline]
  pub fn file_data_position(&self) -> i64 {
    self._tab.get::<i64>(Ioheader::VT_FILE_DATA_POSITION, Some(-1)).unwrap()
  }
  #[inline]
  pub fn description(&self) -> Option<&'a str> {
    self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Ioheader::VT_DESCRIPTION, None)
  }
}
...
pub fn size_prefixed_root_as_ioheader(buf: &[u8]) -> Result<Ioheader, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
pub fn finish_size_prefixed_ioheader_buffer<'a, 'b>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>, root: flatbuffers::WIPOffset<Ioheader<'a>>) {
