...
impl<'a> Ioheader<'a> {
  ...
  pub fn compression(&self) -> Compression {
    ...
    unsafe { self._tab.get::<Compression>(Ioheader::VT_COMPRESSION, Some(Compression::None)).unwrap()}
  }
  #[inline]
  pub fn file_data_position(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(Ioheader::VT_FILE_DATA_POSITION, Some(-1)).unwrap()}
  }
  #[inline]
  pub fn description(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(Ioheader::VT_DESCRIPTION, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> IoheaderBuilder<'a, 'b, A> {
  ...
  pub fn add_compression(&mut self, compression: Compression) {
    self.fbb_.push_slot::<Compression>(Ioheader::VT_COMPRESSION, compression, Compression::None);
  }
  #[inline]
  pub fn add_file_data_position(&mut self, file_data_position: i64) {
    self.fbb_.push_slot::<i64>(Ioheader::VT_FILE_DATA_POSITION, file_data_position, -1);
  }
  #[inline]
  pub fn add_description(&mut self, description: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(Ioheader::VT_DESCRIPTION, description);
  }
  #[inline]
...
pub fn root_as_ioheader(buf: &[u8]) -> Result<Ioheader<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_ioheader(buf: &[u8]) -> Result<Ioheader<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_ioheader_unchecked(buf: &[u8]) -> Ioheader<'_> {
  unsafe { ::flatbuffers::root_unchecked::<Ioheader>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_ioheader_unchecked(buf: &[u8]) -> Ioheader<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<Ioheader>(buf) }
}
...
#[inline]
pub fn finish_size_prefixed_ioheader_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>, root: ::flatbuffers::WIPOffset<Ioheader<'a>>) {
