...
impl<'a> EventPacket<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        args: &'args EventPacketArgs<'args>) -> flatbuffers::WIPOffset<EventPacket<'bldr>> {
  ...
  pub fn elements(&self) -> Option<&'a [Event]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, Event>>>(EventPacket::VT_ELEMENTS, None).map(|v| v.safe_slice())
  }
}
...
#[inline]
pub fn finish_size_prefixed_event_packet_buffer<'a, 'b>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>, root: flatbuffers::WIPOffset<EventPacket<'a>>) {
