...
impl<'a> ::flatbuffers::Follow<'a> for &'a Event {
  ...
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    unsafe { ::flatbuffers::follow_cast_ref::<Event>(buf, loc) }
  }
}
impl<'b> ::flatbuffers::Push for Event {
    ...
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = unsafe { ::core::slice::from_raw_parts(self as *const Event as *const u8, <Self as ::flatbuffers::Push>::size()) };
...
pub fn root_as_event_packet(buf: &[u8]) -> Result<EventPacket<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_event_packet(buf: &[u8]) -> Result<EventPacket<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_event_packet_unchecked(buf: &[u8]) -> EventPacket<'_> {
  unsafe { ::flatbuffers::root_unchecked::<EventPacket>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_event_packet_unchecked(buf: &[u8]) -> EventPacket<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<EventPacket>(buf) }
}
